...
- **business-intelligence-report**, **ceo-reporting-skill**: Common source of the underlying data/analysis for a workbook built here.
- **quarterly-okr-architect**: Source of targets/lead-measures for a tracking or scorecard workbook.
