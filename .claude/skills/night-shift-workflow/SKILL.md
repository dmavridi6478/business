...
- **subagent-depth-control**: If a scheduled workflow spawns nested subagents, that skill's depth setting is another lever for controlling how much unattended work (and token cost) happens per run.
