...
- **content-repurposing-service**: This skill is a ready-made implementation of that playbook's step 4 ("Restore the Human") — run it as the humanity-editing pass before delivering the 7-asset pack.
- **sales-enablement**, **content-strategy**, **doc-coauthoring**, **internal-comms**: Run this as a final pass on drafts from any of these before delivering them to a real reader.

*(See `SOURCE.md` in this directory for provenance — vendored as-is from the upstream repo, MIT licensed.)*
